...
class RabbitMQClient:
    ...
    def __init__(self, host="localhost", queue="permafrost.sensors.temperature"):
        ...
        # 🔧 Robust absolute path resolution for schema file
    ...
    def consume(self, callback):
        ...
        Messages are acknowledged only after successful callback execution.
        """
        self.connect()
